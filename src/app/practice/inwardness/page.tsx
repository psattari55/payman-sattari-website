  ...
  const practices = [
    {
      ...
      subtitle: 'The Art of Meditation',
      description: 'Learn the foundational practice of turning attention inward and creating space for inner experience.',
      icon: Eye,
      color: 'blue',
      practices: [
        { name: 'Observer Meditation', duration: '10 min', level: 'Essential' },
        { name: 'Grounding Practice', duration: '15 min', level: 'Foundation' },
        { name: 'Energy Awareness', duration: '20 min', level: 'Intermediate' }
      ]
    },
    {
      id: 'landscape',
      title: 'Inner Landscape',
      subtitle: 'Understanding What We Find',
    ...
    },
    {
      id: 'detachment',
      title: 'Detachment',
      subtitle: 'Creating Space to See Clearly',
      description: 'Learn the art of disidentification to gain clarity and freedom in your inner work.',
      icon: Unplug,
      color: 'indigo',
      areas: [
    ...
    return (
      ...
      >
        ...
        <div className="p-6">
          ...
          {practice.entities && (
            <div className="space-y-4">
              <h4 className="font-medium text-gray-900">Inner Entities</h4>
              ...
              <div className="p-6">
                <div className="prose max-w-none">
                  <p className="text-gray-700 leading-relaxed">
                    These three practices work together to create a complete foundation for inner work. 
                    We begin by learning to look inward, then develop understanding of what we find, 
                    and finally learn to maintain clear awareness through detachment. This creates the 

          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 mb-8">
              ...
              <div className="prose prose-gray max-w-none">
                <p>
                  These are not traditional koans or mantras. Rather, they are like "codes" that, when understood and spoken with intention, can shift internal energy and unlock deeper states of awareness. Be aware that the power lies not in mere repetition, but in the felt embodiment of their meaning. To put this another way, rather than simply "saying words", you must <em>mean</em> them.

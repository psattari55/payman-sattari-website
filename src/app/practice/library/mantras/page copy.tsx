// src/app/practice/library/mantras/page.tsx
'use client'
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 mb-8">
              ...
              <div className="prose prose-gray max-w-none">
                <p>
                  These are not traditional koans or mantras. Rather, they are like "codes" that, when understood and spoken with intention, can shift internal energy and unlock deeper states of awareness. Be aware that the power lies not in mere repetition, but in the felt embodiment of their meaning. To put this another way, rather than simply "saying words", we must <em>mean</em> them. This is what puts energy into motion.
                  Once you have understood the phrase, repeat it in your mind while feeling deeply its meaning. Note that virtually any of the "Daily Insights" can be used in this same way.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                  <div className="space-y-2">
                    <h3 className="font-medium text-gray-900"><em>Feel</em>, Don't Just Think</h3>
                    <p className="text-sm text-gray-600">
                      Embody the understanding through feeling and touch, rather than keeping it at a conceptual distance by intellectualizing it. Real change happens when thought becomes experience.
                    </p>
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-600">
                      Do your best to keep your center. When working with shifts in energy, it can be easy to be swept along by the current and get distracted. Remain the observer.
                    </p>
                  </div>
                </div>
              </div>

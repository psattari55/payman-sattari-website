        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white border-t border-gray-100">
          ...
          <Section width="default" className="pt-24 pb-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-5xl mb-4">Inner Work</h1>
              ...
              <div className="flex flex-col lg:flex-row gap-12">
                ...
                <div className="prose prose-lg max-w-none">
                  ...
                  <motion.div
                    ...
                    transition={{
                      duration: 0.8,
                      ease: [0.21, 0.45, 0.27, 0.9], // Custom easing
                    }}
                    ...
                    <div id="meditation" className="mb-16">
                      ...
                      <div className="prose prose-lg max-w-none">
                        <p className="text-xl text-gray-700 mb-6">
                          The first step to learning how to use this framework
                          to evolve our personal experience is understanding how
                          to see, understand, and actively work with our inner
                          life. This begins with knowing how to look inward.
                        </p>
                        ...
                        <p className="text-lg leading-relaxed text-gray-800">
                          ...
                          understand its culture and customs, we need to
                          dedicate time to our inner world if we want to become
                          familiar with its landscape and learn to navigate it
                          properly. This might mean setting aside specific times
                          - evenings, mornings, or lunch breaks - or simply
                          maintaining awareness of our inner space throughout
                          the day.
                        </p>
                        ...
                        <p className="text-lg leading-relaxed text-gray-800">
                          ...
                          confusion in our culture that equates consciousness
                          with mind. However, consciousness is a bigger, more
                        ...
                        <p className="text-lg leading-relaxed text-gray-800">
                          ...
                          creates the foundation for all inner work, as it
                          allows us to become aware of the various forces and
                          entities that make up our inner life. Without this
                          fundamental capacity to look inward with presence and
                          awareness, any attempt at inner work would be like
                          trying to navigate a landscape with our eyes closed.
                        </p>
                      </div>
                    </div>
                  </motion.div>
                    ...
                    <div id="landscape" className="mb-16">
                      ...
                      <div className="prose prose-lg max-w-none">
                        <p className="text-xl text-gray-700 mb-8">
                          Like entering a foreign country for the first time,
                          the sheer quantity of different forces at work in our
                          inner world can feel overwhelming, and it can be
                          difficult to discern one thing from another. Having a
                          map of this territory helps us navigate more
                          effectively. Let's explore some of the essential
                          entities we encounter in our inward space.
                        </p>
                        ...
                        <div className="space-y-8 mt-8">
                          ...
                          <div className="bg-white p-6 rounded-lg border border-gray-100">
                            ...
                            <p className="text-lg leading-relaxed text-gray-800">
                              Thoughts are perhaps the most familiar aspect of
                              our inner landscape, yet they come in many forms.
                              While we often experience them as inner dialogue
                              or words, thoughts can also manifest as visual
                              images, sounds, colors, or memories. These are
                              called "thoughtforms" - ideas and concepts taking
                              shape in our mental space.
                            </p>
                            <p className="text-lg leading-relaxed text-gray-800">
                              It's crucial to understand that thoughts are
                              primarily mental entities, associated with the
                              part of us we call "mind." However, this leads to
                              a common confusion in discussions about meditation
                              and inner work - the equation of consciousness
                              with thinking. Mind is an entity that exists
                              within consciousness, but consciousness itself is
                              a bigger, more encompassing reality within which
                              mind and thought occur.
                            </p>
                          </div>
                          ...
                          <div className="bg-white p-6 rounded-lg border border-gray-100">
                            ...
                            <p className="text-lg leading-relaxed text-gray-800">
                              ...
                              are more like waves and vibrations - movements
                              that we sense inwardly. Importantly, these sensory
                            ...
                            <p className="text-lg leading-relaxed text-gray-800">
                              ...
                              more balanced forms like quiet knowing or
                              intuition. Learning to recognize and work with
                              this language of feelings is essential to
                              navigating our inner landscape effectively.
                            </p>
                          </div>
                          ...
                          <div className="bg-white p-6 rounded-lg border border-gray-100">
                            ...
                            <p className="text-lg leading-relaxed text-gray-800">
                              The ego or human personality might seem
                              inseparable from who we are, but when we make the
                              journey inward, we discover it as a distinct
                              entity with its own character, behaviors,
                              qualities, needs, and voice. It is a culmination
                              of all the different aspects of ourselves we have
                              associated with our identity - formed by ideas
                              like "I am a teacher," "I am a survivor," "I had a
                              hard life," and the stories we tell about
                              ourselves.
                            </p>
                            <p className="text-lg leading-relaxed text-gray-800">
                              This entity has developed its own nature based on
                              everything we've fed it over the years about "who
                              we are." It is a more instinctual part of
                              ourselves, deeply related to the inner child. As
                              we learn to observe it, we can begin to recognize
                              its distinct voice and patterns, which is
                              essential for conscious growth and transformation.
                            </p>
                          </div>
                          ...
                          <div className="bg-white p-6 rounded-lg border border-gray-100">
                            ...
                            <p className="text-lg leading-relaxed text-gray-800">
                              ...
                              nature becomes clear when we close our eyes and
                              move our awareness to different parts of the body
                              - feeling the soles of our feet, sensing our
                              abdomen, or experiencing the center of our head.
                            </p>
                            <p className="text-lg leading-relaxed text-gray-800">
                              ...
                              contractions, while meditation and spaciousness
                              can allow our cells to open up and breathe more
                              freely.
                            </p>
                          </div>
                        </div>
                        ...
                        <p className="text-lg leading-relaxed text-gray-800 mt-8">
                          ...
                          landscape helps us work more effectively with our
                          inner reality. Each has its own nature and requires
                          its own approach, yet all are interconnected parts of
                          our complete inner experience.
                        </p>
                      </div>
                    </div>
                  </motion.div>
                    ...
                    <div id="detachment" className="mb-16">
                      ...
                      <div className="prose prose-lg max-w-none">
                        <p className="text-xl text-gray-700 mb-12">
                          Detachment is often misunderstood. When many people
                          hear this word, they think immediately of dissociation
                          or disconnection - to turn away from or reject
                          something. But this is not detachment. Detachment is
                          primarily a process of disidentification—to make
                          ourselves independent of an inner force, recognizing
                          that what we truly are is <em>bigger</em> than any
                          single aspect of our consciousness.
                        </p>
                        ...
                        <p className="text-lg leading-relaxed text-gray-800">
                          ...
                          both are "you," which one exists at a higher level?
                          The one doing the listening - the observer - must be
                        ...
                        <p className="text-lg leading-relaxed text-gray-800">
                          ...
                          independent and neutral doesn't mean you don't care;
                          it means you don't allow your preference for one
                          reality over another to distort your perception.
                        </p>
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 my-6">
                          ...
                          <ul className="list-none space-y-6 my-8">
                            ...
                            <li className="pl-6 border-l-2 border-blue-100">
                              "I have a personality, but I am not my
                              personality"
                            </li>
                          </ul>
                        </div>
                        ...
                        <p className="text-lg leading-relaxed text-gray-800">
                          The importance of detachment lies in its ability to
                          help us see clearly. As long as we are identified with
                          an inner force or entity - whether it's our anger, our
                          thoughts, or our ego - we cannot see it from the
                          outside. We become that entity. Detachment gives us
                          the space we need to work with all the entities of our
                          inner life from a free and independent space.
                        </p>
                        ...
                        <p className="text-lg leading-relaxed text-gray-800">
                          ...
                          both to live a healthy life. Detachment is the tool
                          that allows us to cultivate the objective side with
                          regard to our inner reality.
                        </p>

                        <p className="text-lg leading-relaxed text-gray-800">
                          When we can maintain this neutral, observant stance,
                          we connect more deeply with a part of ourselves that
                          is bigger than any specific form - a part that cannot
                          truly be contained. This freedom is peace, allowing us
                          to work consciously with the forces of our inner lives
                          while maintaining the perspective needed for true
                          transformation.
                        </p>
                      </div>
                    </div>

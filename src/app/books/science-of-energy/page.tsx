...
import { Book, Star, Quote, ShoppingCart, Download, BookOpen, Scale, Compass, Brain, ArrowRight } from 'lucide-react';
...
const retailers = [
  ...
  { name: "Barnes & Noble", href: "https://www.barnesandnoble.com/w/the-science-of-energy-payman-sattari/1144454501?ean=9798989627523" },
  { name: "Kobo", href: "https://www.kobo.com/ww/en/ebook/the-science-of-energy" },
]
...
// Book series data
const seriesData = {
  description: "Offering a unified scientific framework for understanding the nature of reality, experience, and energy. From theoretical foundations to practical applications, this series presents a revolutionary approach to reconciling objective and subjective aspects of existence.",
  books: [
    {
      number: 1,
      title: "The Science of Energy",
      status: "available",
      description: "Establishes the foundational framework for a unified model of energy, consciousness, and matter. Challenges core assumptions about reality while building a bridge between physics and inner experience."
    },
    {
      number: 2,
      title: "Basic Duality",
...
const reviews = [
  {
    ...
    quote: "An excellent and engaging overview of milestones and key discoveries in science... The author effectively tees up his compelling metaphysical premise, that 'conscious experience is not spooky or mysterious. It is part of the natural order.",
  },
  {
...
const editorialReviews = [
    {
      source: "Kirkus Reviews",
      quote: "Sattari offers an excellent and engaging overview of milestones and key discoveries in science, covering Newton, Einstein, Planck, and many others, and he explicates confounding concepts with clarity and drama... The author effectively tees up his compelling metaphysical premise, that 'conscious experience is not spooky or mysterious. It is part of the natural order.'",
      logo: "/images/reviews/kirkus-logo.png"
    },
    {
      source: "Pacific Book Review",
      quote: "Sattari delivers with an engaging blend of clarity and enthusiasm... What sets The Science of Energy apart is Sattari's ability to distill profound ideas into digestible insights, ensuring readers grasp the fundamental principles without getting lost in the intricacies of scientific jargon.",
      logo: "/images/reviews/pacific-logo.webp",
      award: "/images/reviews/notable-book-award.png",
    },
    {
      source: "San Francisco Book Review",
      quote: "The arguments by the author would prove a great topic of discussion among philosophers. Philosophy is a broad subject, and it's always interesting to see someone portray their views with evidence to back them up and not try to impose them on the readers. The author aims to educate, not convince you of his beliefs, which makes the book a good read.",
  ...
  const readerReviews = [
    {
      author: "Max",
      quote: "If you're curious about the mysteries of the universe but feel daunted by heavy science books, Sattari's The Science of Energy is a breath of fresh air. I picked it up hoping to get some new insights into big questions, and honestly, it delivered much more.",
      stars: 5,
      source: "Amazon",
    ...
    },
    {
        ...
        quote: "I really enjoyed reading this book and am looking forward to the next two in the series. Lots of information to make you really think about yourself and the nature of reality.",
        stars: 5,
        source: "Amazon",
        date: "April 14, 2024",
      },
    ...
    {
      author: "Jazzy",
      quote: "This book is amazing, I love anything that allows me to look at myself, and the world around me, and gives insight into the ever-looming questions about ourselves, our purpose, and our place in the universe.",
      stars: 5,
      source: "Goodreads",
      date: "June 26, 2024"
    },
...
export default function ScienceOfEnergyPage() {
      ...
      <PageTransition>
          ...
          <Section width="default" className="pt-24 pb-24">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-12 gap-16 items-center">
                ...
                <div className="space-y-6">
                  ...
                  <div className="prose prose-lg text-gray-700 max-w-none">
                    <p className="text-lg leading-relaxed">
                      A groundbreaking framework for understanding reality at its most fundamental level. Moving beyond traditional divisions between physics and consciousness, this work reveals how existence emerges through complementary forces: the universal and the relative, the measurable and the immeasurable, the continuous and the discrete. Suitable for scholars, seekers, and practitioners alike, it provides both a rigorous theoretical foundation and practical insights for transforming how we experience reality.
                    </p>
                    <p className="text-base text-gray-600 mt-4 leading-relaxed">
                      This first volume establishes the conceptual bedrock necessary for a complete reimagining of reality. Drawing from physics, philosophy, and direct observation, it demonstrates how consciousness and physical matter are two faces of the same cosmic order.
                    </p>
                  </div>
              ...
              <motion.div className="lg:col-span-5">
                <div className="relative max-w-[360px] mx-auto"> {/* Slightly larger */}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            ...
            return (
                ...
                >
                    <Icon className="w-6 h-6 text-gray-600 mb-4" strokeWidth={1.5} />
  ...
  <div className="max-w-6xl mx-auto">
    ...
    />
        ...
        <Section background="white" width="default">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-light mb-12 text-center">A Bridge Between Worlds</h2>
              ...
              {[
                {
                  ...
                  description: "Discover how consciousness and physical reality are two faces of the same cosmic order"
                },
                {
                  icon: Brain,
                  color: "purple",
                  title: "Beyond the Physical",
                  description: "Explore how subjective experience fits into the natural laws governing reality"
                },
                {
                  icon: Compass,
                  color: "green",
                  title: "Personal Integration",
                  description: "Learn how understanding these principles can transform your experience of life"
                }
              ].map((item, index) => (
                <motion.div
                  key={item.title}
                ...
                >
                  <div className={`p-3 bg-${item.color}-50 rounded-lg w-fit mb-6`}>
            ...
            <div className="bg-gray-50 rounded-xl p-8 mb-16">
              <h3 className="text-2xl font-light mb-6 text-center">Core Principles</h3>
              <div className="grid md:grid-cols-2 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Reality emerges through the interplay of apparent opposites: subject/object, continuous/discrete, measurable/immeasurable."
                  },
                  {
                    principle: "Relative & Universal Truth",
                    description: "Individual experience and universal laws are not contradictory but complementary aspects of reality."
                  },
                  {
                    principle: "The Power of Belief",
                    description: "Our beliefs shape our relative reality, making understanding truth essential to transforming experience."
                  }
                ].map((item) => (

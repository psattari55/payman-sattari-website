...
export const articles: Article[] = [
  // Scholar's Door Articles (Scientific Insights)
  {
    ...
    door: "scholar",
    description:
      "Tracing the evolution of truth from ancient beliefs to modern science and proposing a unified framework embracing both subjective and objective reality.",
  ...
  },
  {
    ...
    door: "scholar",
    description:
      "An ontological exploration of reality as a unified field, where discreteness emerges within a continuous, interconnected structure.",
  ...
  },
  {
    ...
    subtitle:
      "Understanding the Role of Abstraction in Science and Mathematics",
    slug: "/articles/scientific/ideal-and-actual",
    category: "scientific",
    door: "scholar",
    description:
      "Examining the role of idealization in science and mathematics, balancing theoretical clarity with real-world complexity.",
  ...
  },
  {
    ...
    door: "scholar",
    description:
      "Examining the limitations of zero-dimensional points in forming a continuum and the role of extension in constructing continuous space.",
  ...
  },
  {
    ...
    door: "scholar",
    description:
      "Exploring the foundational relationship between observer and observed, examining how perception and quantum mechanics challenge traditional notions of objectivity.",
  ...
  },
  {
    ...
    door: "scholar",
    description:
      "Exploring the role of the observer in experiencing qualities like color and sound, and its implications for a more complete view of reality in scientific inquiry.",
  ...
  },
  {
    ...
    door: "scholar",
    description:
      "Examining how modern science redefines the observer's role, highlighting the interplay between external reality and subjective experience.",
  ...
  },
  {
    ...
    door: "scholar",
    description:
      "Exploring the complementary roles of sensory experience and intellectual reasoning in forming a holistic understanding of reality.",
  ...
  //Non-Door Articles (Scientific)
  {
    ...
    category: "scientific",
    description:
      "Examining the profound transition from natural science's philosophical inquiry to technical science's practical applications, and what this shift means for our understanding of reality and the purpose of scientific exploration.",
  ...
  // Observer's Door Articles (Metaphysical)
  {
    ...
    door: "observer",
    description:
      "Exploring the fundamental role of the observer and consciousness in shaping and experiencing reality, bridging measurable phenomena and subjective experience.",
  ...
  },
  {
    ...
    door: "observer",
    description:
      "Exploring the self beyond thoughts and roles, inviting readers to connect with the deeper awareness that transcends identity.",
  ...
  },
  {
    ...
    door: "observer",
    description:
      "Exploring the relationship between the inner and outer in the nature of reality.",
  ...
  },
  {
    ...
    door: "observer",
    description:
      "Exploring how opposite yet complementary forces come together to form the foundation of reality.",
  ...
  },
  {
    ...
    door: "observer",
    description:
      "An exploration of energy dynamics as the interplay between opposites creating a pathway toward inward harmony.",
  ...
  },
  {
    ...
    door: "observer",
    description:
      "Exploring the role of consciousness as creator transforming reality through focus, intention, and awareness.",
  ...
  // Practitioner's Door Articles (Development)
  {
    ...
    door: "practitioner",
    description:
      "Exploring how to transform moments of insight into lasting change through the practice of integration.",
  ...
  },
  {
    ...
    door: "practitioner",
    description:
      "Understanding the relationship between our inner world and outer experience for a more fulfilling life.",
  ...
  },
  {
    ...
    door: "practitioner",
    description:
      "Exploring the nature of belief and its effect on our experience of reality.",
  ...
  },
  {
    ...
    door: "practitioner",
    description:
      "Examining how balancing opposites can create harmony, resilience, and flow in our daily lives.",
    publishDate: "2024-08-26",
    readTime: "6 min",
  },
  {
    ...
    door: "practitioner",
    description:
      "Exploring how to build emotional resilience through self-compassion, presence with emotions, and finding meaning in challenges.",
    publishDate: "2024-07-27",
    readTime: "8 min",
  },
  {
    ...
    door: "practitioner",
    description:
      "Examining grounding as a practice of reconnecting with the Earth, our bodies, and an instinctual wisdom that brings stability and belonging.",
...

  {
    ...
    category: "thoughts",
    description:
      "Exploring how true purpose emerges not from external achievements or validation, but through aligning with our authentic selves and building lives that reflect inner truth.",
    publishDate: "2024-12-09",
    readTime: "10 min",
  },
];
...
export const getAllCategories = () =>
  ["scientific", "metaphysical", "development", "thoughts"] as const;
